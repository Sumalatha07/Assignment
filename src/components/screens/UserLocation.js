    ...
    getCurrentLocation = () => {
      ...
      getUpdatedLocation = () => {
        this.watchID = Geolocation.watchPosition((position) => {
            ...
            var dist = this.distance(this.state.latitude,this.state.longitude, this.state.lastLocationLatitude,  this.state.lastLocationLongitude, 'M')
      ...
      distance1234 = (lat1, lon1, lat2, lon2, unit) => {
